...
public class ClassificationPageFNRP extends TestBase {

	
	
	
	@FindBy(xpath = "//input[@id='pregnancyTestCompleted1']")
	...
	public ClassificationPageFNRP() throws IOException {
	...
	public FinishPage enterClassification() throws InterruptedException {
		...
		WebElement livertest = driver.findElement(By.xpath("//input[@name ='liverTestCompleted' and @value='true']"));
		clickElementByJS2(livertest, driver);
		Select select = new Select(driver.findElement(By.xpath("//select[@id='patientCategory']")));
		select.selectByVisibleText("Female of Non-Reproductive Potential (FNRP)"); 
		pregnancytest.click();
