...
public class ClassificationPageNoPregnancy extends TestBase {
	...
	public ClassificationPageNoPregnancy() throws IOException {
	...
	public FinishPage enterClassification() throws InterruptedException {
		...
		WebElement livertest = driver.findElement(By.xpath("//input[@name ='liverTestCompleted1' and @value='true']"));
